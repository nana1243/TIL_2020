...
def create_authors():
    ...
    Book(title="Test Book 3", year=str(datetime(1986, 1, 3)), author_id=author2.id).create()
    Book(title="Test Book 4", year=str(datetime(1992, 12, 1)), author_id=author2.id).create()
